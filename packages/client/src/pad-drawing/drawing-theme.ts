...
export function writeDrawingThemePreference(preference: DrawingThemePreference) {
...
export function resolveDrawingThemePreference(
    ...
    if (preference === 'app') return resolvedTheme === 'light' ? 'light' : 'dark'
    return preference
}

function isDrawingThemePreference(value: string | null): value is DrawingThemePreference {
