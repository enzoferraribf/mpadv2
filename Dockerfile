...
WORKDIR /app
COPY package.json bun.lock tsconfig.base.json tsconfig.bun.json tsconfig.package.json ./
...
COPY --from=production-deps /app/tsconfig.package.json ./tsconfig.package.json
