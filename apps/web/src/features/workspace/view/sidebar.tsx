...
export function PadSidebar(input: {
    ...
    return (
        <aside className='pad-sidebar'>
            <div
                className='pad-sidebar-section-label'
            ...
            <div className='pad-sidebar-footer'>
                <button
                    className='pad-sidebar-help-btn'
                ...
                {helpOpen ? (
                    <div className='pad-sidebar-help'>
                        <div className='pad-sidebar-help-row'>
                            <code>#</code> Heading &nbsp; <code>**b**</code>{' '}
                            Bold &nbsp; <code>*i*</code> Italic
                        </div>
                        <div className='pad-sidebar-help-row'>
                            <code>- item</code> List &nbsp; <code>&gt;</code>{' '}
