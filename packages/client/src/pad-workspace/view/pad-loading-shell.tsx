        ...
        <div className='app-main'>
            <section className='loading-shell workspace-shell'>
                <div className='loading-card'>
                    <span className='mpad-logo mpad-logo-lg'>
                        <span className='mpad-logo-m'>M</span>PAD
                    </span>
                    <p className='text-sm text-[--stone-text-secondary]'>
                        {input.phrase ?? getRandomPhrase()}
                    </p>
                </div>
            </section>
            <PadStatusBar
                    ...
                    {(input.activeTab ?? 'text') === 'text' ? (
                        <div className='pad-tab-actions'>
                            ...
                            <button
                                ...
                                onClick={() =>
                                    (input.onSetLayout ?? noop)('preview')
                                }
                                title='Preview only'
                                type='button'
                            >
