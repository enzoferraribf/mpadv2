import type { reduceFileMachine } from '@/features/files/domain/state'
import type { PadFileRoom } from '@/shared/realtime/client'
import type { LiveFileMeta } from '@mpad/protocol/live-files'
import { toast } from 'sonner'
import { type FilePeerSession, closeFilePeer, openFilePeer } from './peer'
import type { LocalFile } from './store'
import { saveLocalFile } from './store'
