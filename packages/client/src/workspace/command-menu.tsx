...
import type { PadWorkspaceActions, PadWorkspaceLayout } from './use-pad-workspace'
...
function setLayout(input: { actions: PadWorkspaceActions; onOpenChange: (open: boolean) => void }, layout: PadWorkspaceLayout) {
    input.actions.closeDialog()
    input.actions.setLayout(layout)
}

function run(input: { actions: PadWorkspaceActions; onOpenChange: (open: boolean) => void }, action: () => void) {
    input.actions.closeDialog()
    action()
}
