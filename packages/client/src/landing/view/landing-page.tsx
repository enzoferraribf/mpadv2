...
const FEATURES = [
    {
        idx: '01',
        name: 'Markdown',
        desc: 'Write in markdown with live split preview. Syntax highlighting, headings, lists, blockquotes.',
    },
    {
        idx: '02',
        name: 'Drawing',
        desc: 'One shared canvas per pad. Every stroke syncs in real time to every connected peer.',
    },
    {
        idx: '03',
        name: 'Live files',
        desc: 'Drop files into a pad. Everyone grabs them. No upload, no storage. Files live with the session.',
    },
    {
        idx: '04',
        name: 'Presence',
        desc: 'See who is editing. Cursors, names, connection status. You feel the collaboration.',
    },
    {
        idx: '05',
        name: 'Persistence',
        desc: 'Text and drawings auto-save. Come back later, everything is still there. No save button.',
    },
    {
        idx: '06',
        name: 'Pad trees',
        desc: 'Pads live at paths. Paths create natural hierarchy. Navigate related pads by structure.',
    },
] as const
...
const STEPS = [
    {
        ...
        text: (
            <>
                <strong>Open a URL.</strong> Any path becomes a pad. No sign-up,
                no install, no waiting.
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <strong>Write and draw.</strong> Markdown on the left, preview
                on the right. Switch to the canvas to sketch.
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <strong>Share the link.</strong> Anyone with the URL joins
                instantly. You see their cursor, they see yours.
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <strong>Drop files.</strong> Drag a file in and everyone
                connected can download it. No cloud, no limits.
            </>
        ),
    },
] as const
    ...
    return (
        <nav className='landing-nav'>
            <div className='landing-nav-left'>
                <a href='/' className='landing-nav-wordmark'>
                    <span className='landing-nav-logo-m'>M</span>PAD
                </a>
                <div className='landing-nav-sep' />
                <div className='landing-nav-label'>
    ...
    return (
        <section className='landing-hero'>
            <div className='landing-hero-text'>
                <div className='landing-hero-super'>
                ...
                <p className='landing-hero-desc'>
                    A real-time collaborative pad for markdown, drawing, and
                    file sharing. No accounts, no friction. Open a URL and
                    start.
                </p>
                <div className='landing-hero-actions'>
                    <LandingPadInput
                        ...
                        variant='full'
                    />
                    <div className='landing-pad-input-hint'>
                ...
                <div className='landing-features-grid'>
                    {FEATURES.map((feature) => (
                        <div key={feature.idx} className='landing-feature-cell'>
                            <div className='landing-feature-idx'>
                                {feature.idx}
                            </div>
                            <div className='landing-feature-name'>
                                {feature.name}
                            </div>
